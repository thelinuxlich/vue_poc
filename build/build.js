...
},{"../parsers/directive":48,"../parsers/expression":49,"../parsers/path":50,"../parsers/text":52,"../watcher":64}],4:[function(require,module,exports){
var _ = require('../util')
...
},{"../compiler/compile":10,"../compiler/transclude":12,"../config":13,"../parsers/directive":48,"../parsers/expression":49,"../parsers/path":50,"../parsers/template":51,"../parsers/text":52,"../util":59}],7:[function(require,module,exports){
var _ = require('../util')
...
},{"../config":13,"../directives/component":18,"../directives/prop":30,"../parsers/directive":48,"../parsers/template":51,"../parsers/text":52,"../util":59}],11:[function(require,module,exports){
var _ = require('../util')
...
},{"../util":59}],12:[function(require,module,exports){
var _ = require('../util')
var config = require('../config')
var templateParser = require('../parsers/template')
...
},{"../config":13,"../parsers/template":51,"../util":59}],13:[function(require,module,exports){
module.exports = {
...
},{"./config":13,"./parsers/expression":49,"./parsers/text":52,"./util":59,"./watcher":64}],15:[function(require,module,exports){
// xlink
...
},{"../util":59}],17:[function(require,module,exports){
var config = require('../config')
...
},{"../parsers/template":51,"../util":59}],19:[function(require,module,exports){
module.exports = {
...
},{"../parsers/template":51,"../util":59}],22:[function(require,module,exports){
var _ = require('../util')
var compile = require('../compiler/compile')
var templateParser = require('../parsers/template')
var transition = require('../transition')
...
},{"../compiler/compile":10,"../parsers/template":51,"../transition":53,"../util":59}],23:[function(require,module,exports){
...
},{"./attr":15,"./class":16,"./cloak":17,"./component":18,"./el":19,"./events":20,"./html":21,"./if":22,"./model":25,"./on":29,"./prop":30,"./ref":31,"./repeat":32,"./show":33,"./style":34,"./text":35,"./transition":36}],24:[function(require,module,exports){
var _ = require('../../util')
...
},{"../../util":59,"./checkbox":24,"./radio":26,"./select":27,"./text":28}],26:[function(require,module,exports){
var _ = require('../../util')
...
},{"../../parsers/directive":48,"../../util":59,"../../watcher":64}],28:[function(require,module,exports){
var _ = require('../../util')
...
},{"../util":59}],30:[function(require,module,exports){
var _ = require('../util')
var Watcher = require('../watcher')
...
},{"../parsers/path":50,"../util":59,"../watcher":64}],31:[function(require,module,exports){
var _ = require('../util')
...
},{"../util":59}],32:[function(require,module,exports){
var _ = require('../util')
...
},{"../compiler/compile":10,"../compiler/transclude":12,"../parsers/expression":49,"../parsers/template":51,"../parsers/text":52,"../util":59}],33:[function(require,module,exports){
var transition = require('../transition')
...
},{"../transition":53}],34:[function(require,module,exports){
var _ = require('../util')
...
},{"../util":59}],36:[function(require,module,exports){
var _ = require('../util')
...
},{"../transition/transition":55,"../util":59}],37:[function(require,module,exports){
var _ = require('../util')
var Path = require('../parsers/path')
...
},{"../parsers/path":50,"../util":59}],38:[function(require,module,exports){
var _ = require('../util')
...
},{"../compiler/compile":10,"../compiler/transclude":12,"../directive":14,"../util":59}],40:[function(require,module,exports){
var _ = require('../util')
var inDoc = _.inDoc
...
},{"../util":59}],42:[function(require,module,exports){
var _ = require('../util')
...
},{"../observer":46,"../observer/dep":45,"../util":59}],44:[function(require,module,exports){
var _ = require('../util')
...
module.exports = Dep
},{"../util":59}],46:[function(require,module,exports){
var _ = require('../util')
var config = require('../config')
var Dep = require('./dep')
...
},{"../config":13,"../util":59,"./array":44,"./dep":45,"./object":47}],47:[function(require,module,exports){
var _ = require('../util')
...
},{"../cache":9,"../util":59}],49:[function(require,module,exports){
var _ = require('../util')
...
},{"../cache":9,"../util":59,"./path":50}],50:[function(require,module,exports){
var _ = require('../util')
var Cache = require('../cache')
...
},{"../cache":9,"../util":59}],52:[function(require,module,exports){
var Cache = require('../cache')
var config = require('../config')
...
},{"../cache":9,"../config":13,"./directive":48}],53:[function(require,module,exports){
var _ = require('../util')
...
},{"../util":59,"./queue":54}],56:[function(require,module,exports){
var config = require('../config')
...
},{"./debug":56,"./dom":57,"./env":58,"./lang":60,"./misc":61,"./options":62}],60:[function(require,module,exports){
/**
...
},{"../config":13,"./index":59}],62:[function(require,module,exports){
var _ = require('./index')
var extend = _.extend
...
},{"./index":59}],63:[function(require,module,exports){
var _ = require('./util')
var extend = _.extend
...
},{"./api/child":2,"./api/data":3,"./api/dom":4,"./api/events":5,"./api/global":6,"./api/lifecycle":7,"./compiler/content":11,"./directives":23,"./filters":38,"./instance/compile":39,"./instance/events":40,"./instance/init":41,"./instance/misc":42,"./instance/scope":43,"./util":59}],64:[function(require,module,exports){
var _ = require('./util')
var config = require('./config')
var Observer = require('./observer')
var expParser = require('./parsers/expression')
...
},{"./batcher":8,"./config":13,"./observer":46,"./parsers/expression":49,"./util":59}],65:[function(require,module,exports){
require("insert-css")("html{font-family:Helvetica}.blue{color:#69D2E7}");
var __vue_template__ = "<h1 class=\"dork\">This is the app</h1>\n    <yb_cart custom=\"banana\" dynamic=\"{{dynamic}}\"></yb_cart>\n    <yb_footer>\n        <div>\n            <strong>Custom content</strong>\n        </div>\n    </yb_footer>\n    <yb_footer inline-template=\"\" class=\"blue\">\n        <div class=\"blue\">\n            <strong>Here we are overwriting the whole footer template, but we still have access to its properties: {{msg}}</strong>\n        </div>\n    </yb_footer>";
module.exports = {
    data: function() {
        return {
            dynamic: "Hello from App!"
        }
    },
    components: {
        yb_cart: require("./components/yb_cart.vue"),
        yb_footer: require("./components/yb_footer.vue")
    },
    created: function() {
        this.$on("yb_footer:ready", function(data) {
            console.log(data);
        });
    }
};
...
},{"./components/yb_cart.vue":66,"./components/yb_footer.vue":67,"insert-css":1}],66:[function(require,module,exports){
require("insert-css")(".green{color:green}");
var __vue_template__ = "<h2 class=\"green\">{{msg}}</h2>\n  <h2 class=\"green\">This is coming from a static parameter passed directly to the component: {{custom}}</h2>\n  <h2 class=\"green\">This is coming from a dynamic parameter passed directly to the component: {{dynamic}}</h2>";
module.exports = {
...
var __vue_template__ = "<div class=\"red\">\n        <h2>{{msg}}</h2>\n        <content>This will be displayed if no content is inserted</content>\n    </div>";
module.exports = {
    data: function () {
        return {
    ...
    ready: function() {
        this.$dispatch("yb_footer:ready", "This event was fired when the yb_footer was fully initialized.");
    }
}
;(typeof module.exports === "function"? module.exports.options: module.exports).template = __vue_template__;

},{"insert-css":1}],68:[function(require,module,exports){
var Vue = require('vue'),
    appOptions = require('./app.vue'),
    app = new Vue(appOptions).$mount('#app');
},{"./app.vue":65,"vue":63}]},{},[68]);
